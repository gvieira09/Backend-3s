...
public class FilmeController : ControllerBase
{
    ...
    public async Task<IActionResult> Post([FromForm]FilmeDTO novoFilme)
    {
        ...
        filme.IdGenereo = novoFilme.IdGenero.ToString();
    ...
    public async Task<IActionResult> Put(Guid id, FilmeDTO filme)
    {
        ...
        if(filme.IdGenero != null && filme.IdGenero.ToString()!= filmeBuscado.IdGenereo)
            filmeBuscado.IdGenereo = filme.IdGenero.ToString(); 
